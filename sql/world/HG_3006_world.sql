...
UPDATE `creature_template` SET `MovementType` = '2',`ScriptName` = 'npc_anchorite_truuen' WHERE `entry` = 17238;
...
(17238, 23, 974.954, -1825.33, 81.3482, 10000, '0'),
(17238, 24, 974.954, -1825.33, 81.3482, 10000, '0'),
(17238, 25, 974.954, -1825.33, 81.3482, 10000, '0'),
(17238, 26, 974.954, -1825.33, 81.3482, 10000, '0');