...
CREATE TABLE `eventai_scripts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2816336 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=FIXED COMMENT='EventAI Scripts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `creature_template` (
  ...
  `IconName` varchar(300) DEFAULT NULL,
  ...
  `AIName` varchar(192) DEFAULT NULL,
  ...
  `ScriptName` varchar(192) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gameobject` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB AUTO_INCREMENT=3461740 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `game_tele` (
  ...
  `name` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=535 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `db_version` (
  `version` varchar(120) COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16777014 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `eventai_texts` (
  ...
  `comment` text,
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=FIXED COMMENT='Script Texts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `eventai_summons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=FIXED COMMENT='EventAI Summoning Locations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spell_dbc` (
  ...
  `attributes` varchar(96) DEFAULT NULL,
  `attributesEx` varchar(96) DEFAULT NULL,
  `attributesEx2` varchar(96) DEFAULT NULL,
  `attributesEx3` varchar(96) DEFAULT NULL,
  `attributesEx4` varchar(96) DEFAULT NULL,
  `attributesEx5` varchar(96) DEFAULT NULL,
  `attributesEx6` varchar(96) DEFAULT NULL,
...
-- Dump completed on 2010-07-01 10:57:39
