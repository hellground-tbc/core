...
DROP TABLE IF EXISTS `game_tele`;CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=541 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
DROP TABLE IF EXISTS `gameobject`;CREATE TABLE `gameobject` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB AUTO_INCREMENT=3699076 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
