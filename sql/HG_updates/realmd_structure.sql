...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(11) unsigned DEFAULT '11723',
  PRIMARY KEY (`id`),
...
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Account System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2010-07-01 11:03:19
