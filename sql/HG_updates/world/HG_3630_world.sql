...
UPDATE creature_template SET ScriptName = "mob_illidari_battle_mage" WHERE entry = 23402;
...
UPDATE creature_template SET minlevel = 72, maxlevel = 72, minhealth = 1000, maxhealth = 1000, faction_A = 16, faction_H = 16, flags_extra = 130, ScriptName = "mob_arcane_charge" WHERE entry = 23429;