...
CREATE TABLE `saved_variables` (
  `NextArenaPointDistributionTime` double DEFAULT NULL,
  `HeroicQuest` double DEFAULT NULL,
  `NormalQuest` double DEFAULT NULL,
  `CookingQuest` double DEFAULT NULL,
  `FishingQuest` double DEFAULT NULL,
  `PVPAlliance` double DEFAULT NULL,
  `PVPHorde` double DEFAULT NULL
...
CREATE TABLE `character_tutorial` (
  ...
  KEY `acc_key` (`account`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Player System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2010-07-01 11:02:55
