...
void RealmList::UpdateRealms(bool init)
{
    ...
    QueryResultAutoPtr  result = LoginDatabase.Query( "SELECT id, name, address, port, icon, color, timezone, allowedSecurityLevel, population FROM realmlist WHERE color <> 3 ORDER BY name" );
