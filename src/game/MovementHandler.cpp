...
void WorldSession::HandleMoverRelocation(MovementInfo& movementInfo)
{
    ...
    {
        if (sWorld.getConfig(CONFIG_ENABLE_PASSIVE_ANTICHEAT) && !plMover->hasUnitState(UNIT_STAT_LOST_CONTROL | UNIT_STAT_NOT_MOVE) && plMover->GetSession()->GetSecurity() == SEC_PLAYER && plMover->m_AC_timer == 0)
