...
public:
    ...
    /* Item */
    bool OnDummyEffect(Unit* pCaster, uint32 spellId, uint8 effIndex, Item* pTarget);
    ...
    /* Creature */
    bool OnDummyEffect(Unit* pCaster, uint32 spellId, uint8 effIndex, Creature* pTarget);
    ...
    /* GameObject */
    bool OnDummyEffect(Unit* pCaster, uint32 spellId, uint8 effIndex, GameObject* pTarget);
    ...
    void OnBindToInstance(Player* pPlayer, DungeonDifficulties difficulty, uint32 mapid, bool permanent);
