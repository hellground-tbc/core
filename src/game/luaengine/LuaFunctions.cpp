...
{
    // Other
    {"ToGameObject", &LuaWorldObject::ToGameObject},                    // :ToGameObject()
    {"ToUnit", &LuaWorldObject::ToUnit},                                // :ToUnit()
    {"ToCreature", &LuaWorldObject::ToCreature},                        // :ToCreature()
    {"ToPlayer", &LuaWorldObject::ToPlayer},                            // :ToPlayer()
    {"ToCorpse", &LuaWorldObject::ToCorpse},                            // :ToCorpse()
