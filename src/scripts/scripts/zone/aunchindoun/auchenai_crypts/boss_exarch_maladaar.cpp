...
struct HELLGROUND_DLL_DECL mob_stolen_soulAI : public ScriptedAI
{
...
struct HELLGROUND_DLL_DECL boss_exarch_maladaarAI : public ScriptedAI
{
...
struct HELLGROUND_DLL_DECL mob_avatar_of_martyredAI : public ScriptedAI
{
