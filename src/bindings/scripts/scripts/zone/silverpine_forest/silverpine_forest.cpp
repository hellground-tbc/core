...
struct HELLGROUND_DLL_DECL npc_astor_hadrenAI : public ScriptedAI
{
...
struct HELLGROUND_DLL_DECL npc_deathstalker_erlandAI : public npc_escortAI
{
...
struct HELLGROUND_DLL_DECL pyrewood_ambushAI : public ScriptedAI
{
