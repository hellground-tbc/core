    ...
    {    /*TODO list:
        ...
        */
        ...
        case 5:
            ...
            m_creature->MonsterMoveWithSpeed(GRAVITY_X-0.5f, GRAVITY_Y, GRAVITY_Z+25.0f, 12000);
        ...
        case 14:
            return 2000;
        case 15:
            m_creature->MonsterMoveWithSpeed(GRAVITY_X-1.0f, GRAVITY_Y, GRAVITY_Z, 13000);
...
struct TRINITY_DLL_DECL mob_nether_vaporAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        if(Move_Timer < diff)
        {
            ...
            m_creature->MonsterMoveWithSpeed(newX, newY, newZ, 2500);
            Move_Timer = 3000;
        }
        else
            Move_Timer -= diff;
